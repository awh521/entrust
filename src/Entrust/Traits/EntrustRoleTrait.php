...
trait EntrustRoleTrait
{
    ...
    {
        return $this->belongsToMany(Config::get('entrust.user_table')?:Config::get('auth.providers.users.model'), Config::get('entrust.role_user_table'),Config::get('entrust.role_foreign_key'),Config::get('entrust.user_foreign_key'));
